    ...
    <div class="row">
      ...
      <div class="col-md-10">
        ...
        <div class="box box-info">
          ...
          <!-- /.box-header -->
          <!-- form start -->
          <form class="form-horizontal" method="Post" action="{{ url(LaravelLocalization::setLocale().'/cms/permissions/').'/'.$permission->id }}">
            <div class="box-body">
            ...
            <div class="flash-message">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" name="name" id="inputTitle" placeholder="name" name="title" value="{{ $permission->name }}">
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="inputdescription" placeholder="description" name="description" value="{{ $permission->description }}">
                </div>
              </div>
            </div>
            <!-- /.box-body -->
